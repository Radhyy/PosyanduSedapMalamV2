...
import KaderSidebar from "@/components/KaderSidebar";
      ...
      <main className="flex-1 flex flex-col">
        ...
        <header className="h-20 bg-white border-b border-gray-100 flex items-center justify-between px-8 sticky top-0 z-10">
          ...
          <div className="hidden md:flex items-center gap-2">
            <h2 className="font-bold text-xl text-gray-900 tracking-tight">Panel Kader Posyandu</h2>
          </div>
          <div className="flex items-center gap-5">
            ...
            <div className="flex items-center gap-3 bg-white border border-gray-100 pl-2 pr-4 py-1.5 rounded-full shadow-sm cursor-pointer hover:bg-gray-50 transition-colors">
              <div className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center overflow-hidden">
                <img src="https://api.dicebear.com/7.x/notionists/svg?seed=Kader&backgroundColor=f3f4f6" alt="Kader" width={32} height={32} />
              </div>
              <span className="text-sm font-bold text-gray-900">Kader</span>

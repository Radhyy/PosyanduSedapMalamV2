    ...
    <div className="max-w-2xl mx-auto">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-500">Buat akun untuk Admin atau Kader Posyandu</p>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <input type="text" id="username" name="username" required placeholder="Tanpa spasi"
                className="w-full px-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-posyandu-blue focus:border-posyandu-blue outline-none transition-all" />
            </div>
            <div className="space-y-1.5">
          ...
          <div className="space-y-1.5">
            <label htmlFor="role" className="text-sm font-medium text-gray-700">Peran (Role) <span className="text-red-500">*</span></label>
            <select 
              id="role" 
              name="role" 
              value={selectedRole}
              onChange={(e) => setSelectedRole(e.target.value)}
              className="w-full px-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-posyandu-blue focus:border-posyandu-blue outline-none transition-all bg-white"
            >
              <option value="admin">Admin</option>
              <option value="kader">Kader</option>
            </select>
            <p className="text-xs text-gray-500 mt-1">Hanya Admin yang dapat menambahkan Admin atau Kader baru. Akun Orang Tua didaftarkan secara terpisah.</p>
          </div>
          ...
          {selectedRole === "kader" && (
            <div className="p-4 bg-gray-50 rounded-xl border border-gray-200 space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <input type="text" id="nikKader" name="nikKader" required maxLength={16} placeholder="16 Digit NIK KTP"
                  className="w-full px-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-posyandu-blue focus:border-posyandu-blue outline-none transition-all" />
              </div>
            </div>
          )}
          ...
          <div className="pt-4 flex justify-end">
            <button type="submit" disabled={isSubmitting}
              ...
              {isSubmitting ? (
                ...
                <><i className="fa-solid fa-user-plus"></i> Buat Pengguna</>
              )}
            </button>
          </div>

...
export default function MouseEffects({
    color = "#3b82f6", // default posyandu blue color
    interactionMode = "particles", // changed default to particles for a nice effect
    duration = 0.5,
    strokeWidth = 3,
    effectSize = 90,
    rotation = 0,
    showLabel = false, // disabled by default for overlay
